    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Hashtag Add</h3>
            </div>
            <?php echo form_open('hashtag/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="followers" class="form-control" id="followers"><?php echo $this->input->post('followers'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
