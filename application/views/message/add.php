                ...
                <div class="row clearfix">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="user_id" value="<?php echo $this->input->post('user_id'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="to_id" value="<?php echo $this->input->post('to_id'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="accept_status"
                                value="<?php echo $this->input->post('accept_status'); ?>" class="form-control"
                                id="accept_status" />
                    ...
                    <div class="col-md-6">
                        <label for="del_status" class="control-label"><span class="text-danger">*</span>Del
                            Status</label>
                        <div class="form-group">
                            <input type="text" name="del_status" value="<?php echo $this->input->post('del_status'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="cdate" value="<?php echo $this->input->post('cdate'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="mdate" value="<?php echo $this->input->post('mdate'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <textarea name="msg" class="form-control"
                                id="msg"><?php echo $this->input->post('msg'); ?></textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <textarea name="to_msg" class="form-control"
                                id="to_msg"><?php echo $this->input->post('to_msg'); ?></textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <textarea name="block" class="form-control"
                                id="block"><?php echo $this->input->post('block'); ?></textarea>
