          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="post_id" value="<?php echo $this->input->post('post_id'); ?>" class="form-control" id="post_id" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="comment_image" value="<?php echo $this->input->post('comment_image'); ?>" class="form-control" id="comment_image" />
