    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Report User Add</h3>
            </div>
            <?php echo form_open('report_user/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="report_user_id" value="<?php echo $this->input->post('report_user_id'); ?>" class="form-control" id="report_user_id" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="mdate" value="<?php echo $this->input->post('mdate'); ?>" class="form-control" id="mdate" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="report_text" class="form-control" id="report_text"><?php echo $this->input->post('report_text'); ?></textarea>
